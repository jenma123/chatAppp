...
import 'package:watsappclone/presentation/pages/phone_varification_page.dart';
import 'package:watsappclone/presentation/pages/set_initial_profile_page.dart';
                    ...
                    builder: (context, userState) {
                      if (userState is UserLoaded) {
                        final currentUserInfo = userState.users.firstWhere(
                            ...
                            orElse: () => UserModel(name: '', isOnline: false, phoneNumber: '', email: '', uid: '', status: '', profileUrl: ''));
                        return HomeScreen(
