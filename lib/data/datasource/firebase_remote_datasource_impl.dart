...
import 'package:watsappclone/data/model/my_chat_model.dart';
import 'package:watsappclone/data/model/text_message_model.dart';
  ...
  Future<String> getOneToOneSingleUserChannelId(String uid, String otherUid) {
    ...
    return userCollectionRef
      ...
      if (engagedChatChannel.exists) {
        return (engagedChatChannel.data() as dynamic)['channelId'];
      }
